...
QString MyWstyle::StyleStondareQHeader(const QString mcolor,const QFont & f)
{
    ...
    return "QHeaderView::section {"
            ...
            "stop:0 #c7d2d2, stop: 0.5 #e0eaec,"
            "stop: 0.6 #d5dddc, stop:1 #d7d2d2);"
            "color: #45a1fe;"
            "padding-left: 4px;"
            "text-align: center;"
            ...
            "background-color: qlineargradient(x1:0, y1:0, x2:0, y2:1,"
            "stop:0 #dac4a2, stop: 0.5 #e0eaec,"
            "stop: 0.6 #d5dddc, stop:1 #dac4a2);"
            "color: #45a1fe;"
            "padding-left: 4px;"
            "text-align: center;"
...
{
    return QLatin1String("QTabWidget::pane"
                         "{"
